        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            @if (Route::has('login'))
                @auth
                <li class="nav-item">
                    <a class="nav-link" style="background-color: aqua;color:black" href="MyAppoinment">My apoinment</a>
                  </li>
        ...
        <table>
            ...
            @foreach ($appoint as $appoints)
                ...
                <tr style="background-color: black;" align="center">
                    ...
                    <td><a class="btn btn-danger" onclick="return confirm('are u sure aboit that ?')" href="{{url('cancel_appoint',$appoints->id)}}">cancel</a></td>
                </tr>
            @endforeach
